 ...
 */
final class Version20250211011106 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE formulario (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(45) NOT NULL, paternal_name VARCHAR(50) NOT NULL, maternal_name VARCHAR(50) NOT NULL, street VARCHAR(46) NOT NULL, phone VARCHAR(255) NOT NULL, company_name VARCHAR(100) NOT NULL, company_number VARCHAR(45) NOT NULL, images_ine VARCHAR(100) NOT NULL, images_stree VARCHAR(40) NOT NULL, images_nomina VARCHAR(50) NOT NULL, requested_amount VARCHAR(40) NOT NULL, bank VARCHAR(45) NOT NULL, interbank VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
