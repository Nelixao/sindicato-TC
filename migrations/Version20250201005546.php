 ...
 */
final class Version20250201005546 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE company (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, create_date DATETIME NOT NULL, upda_date DATETIME NOT NULL, rfc VARCHAR(45) NOT NULL, company_name VARCHAR(45) NOT NULL, status VARCHAR(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
